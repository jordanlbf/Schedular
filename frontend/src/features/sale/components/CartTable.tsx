...
function CartItemRow({ line, product, onChangeQty, onRemove, onPriceChange }: CartItemRowProps) {
  ...
  const totalPrice = useMemo(() => formatPrice(line.qty * line.price), [line.qty, line.price]);
